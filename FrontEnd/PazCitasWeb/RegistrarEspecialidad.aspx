<%@ Page Title="" Language="C#" MasterPageFile="~/PazCitasAdmin.Master" AutoEventWireup="true" CodeBehind="RegistrarEspecialidad.aspx.cs" Inherits="PazCitasWA.RegistrarEspecialidad" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Registrar Especialidad
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Scripts" runat="server">
    <script src="Scripts/PazCitasS/RegistrarEspecialidad.js"></script>
</asp:Content>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row align-items-start">
                    <asp:Label ID="lblDescripcion" CssClass="col-form-label col-sm-auto pe-sm-2 fw-bold " runat="server" Text="Descripción:"></asp:Label>
                    <div class="col-sm-8">

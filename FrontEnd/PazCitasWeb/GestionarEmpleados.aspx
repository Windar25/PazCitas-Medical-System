<%@ Page Title="" Language="C#" MasterPageFile="~/PazCitasAdmin.Master" AutoEventWireup="true" CodeBehind="GestionarEmpleados.aspx.cs" Inherits="PazCitasWA.GestionarEmpleados" %>
                    ...
                    <a href="GestionarMedicos.aspx" class="text-decoration-none">
                        <div class="card shadow-sm h-100 border-0 hover-shadow card-medicos">
                            <div class="card-body text-center">
                                ...
                                <h4 class="fw-bold mb-0">Gestionar Médicos</h4>
                                <p class="card-desc">
                                    Añadir, modificar y eliminar médicos
                                </p>
                            </div>
                        </div>
                    </a>
